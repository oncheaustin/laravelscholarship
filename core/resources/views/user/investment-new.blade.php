            ...
            <div class="row">
                ...
                @foreach($plan as $p)
                    ...
                    <div style="font-size: 18px;padding: 18px;" class="panel-body text-center">
                            <img class="" style="width: 100%;border-radius: 5px" src="{{ asset('assets/images') }}/{{ $p->image }}" alt="">
                        </div>
                            <div style="font-size: 18px;padding: 18px;" class="panel-body text-center">
                            ...
                            <ul style='font-size: 15px;' class="list-group text-center bold">
                                ...
                                <li class="list-group-item"><i class="fa fa-check"></i> {{ $p->compound->name }} {{ $p->percent }}% for {{ $p->time }} cycle </li>
                                ...
                                <div class="col-sm-12">
                                    <form method="POST" action="{{ route('investment-post') }}" class="form-inline">
                                        ...
                                        <button type="submit" class="btn btn-primary bold uppercase btn-block btn-icon icon-left">
                                            <i class="fa fa-send"></i> Sponsor This Product
                                        </button>
                                    </form>
                                </div>
                            </div>
