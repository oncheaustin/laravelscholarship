                ...
                <div class="col-sm-12 text-center">
                    <div class="panel panel-primary panel-pricing">
                        ...
                        <div class="panel-footer" style="overflow: hidden">
                            <div class="col-sm-12">
                                <a href="{{ route('withdraw-request') }}" class="btn bold uppercase btn-info btn-block btn-icon icon-left"><i class="fa fa-arrow-left"></i> Another Method</a>
                            </div>
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label style="margin-top: 5px;font-size: 14px;" class="col-sm-2 bold uppercase text-right  control-label">Bank Name : </label>

                                <div class="col-sm-8">
<input type="text" name="bank" id="" value="{{$user->bank}}" class="form-control input-lg" required placeholder="Bank Name">
                                </div>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="form-group">
                                <label style="margin-top: 5px;font-size: 14px;" class="col-sm-2 bold uppercase text-right  control-label">Account Name : </label>
...
<input type="text" name="account_name" id="" value="{{$user->account_name}}" class="form-control input-lg" required placeholder="Account Name">
                        ...
                        <br>
                            ...
                            <div class="form-group">
                                <label style="margin-top: 5px;font-size: 14px;" class="col-sm-2 bold uppercase text-right  control-label">Account No : </label>

                                <div class="col-sm-8">
<input type="text" name="account_no" id="" value="{{$user->account_no}}" class="form-control input-lg" required placeholder="Account No">
                                </div>
                            </div>
                        </div>
                        <br>
         <!---               
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label style="margin-top: 5px;font-size: 14px;" class="col-sm-2 bold uppercase text-right  control-label">Payment Details : </label>
