                        ...
                        @if(Auth::check())
                            <li><a href="#">Hi. {{ Auth::user()->name }} <i class="fa fa-caret-down"></i></a>
                                <ul class="sub-menu">
                                  ...
                                  <!---   <li><a href="{!! route('wallet.settings') !!}">Wallet Settings </a></li> -->
                                   <!--  <li><a href="{{ route('go2fa') }}">2FA Security </a></li>
            ...
            <div class="row ">
                <div class="col-md-8 col-md-offset-2">
                   ...
                   <div class="footer-logo">
                        <a href="{{ route('home') }}"><img src="{{ asset('assets/images/comodo_secure_seal_113x59_transp.png') }}" alt="Footer Logo"></a>
                    </div> 
